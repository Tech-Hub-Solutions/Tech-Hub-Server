...
-- Soft Skills -66
('Adaptabilidade', null, 'soft-skill'),
('Aprendizado Contínuo', null, 'soft-skill'),
('Altruísmo', null, 'soft-skill'),
('Ambição', null, 'soft-skill'),
('Atenção aos Detalhes', null, 'soft-skill'),
('Autodisciplina', null, 'soft-skill'),
('Cidadania Corporativa', null, 'soft-skill'),
('Colaboração', null, 'soft-skill'),
('Comunicação', null, 'soft-skill'),
('Comprometimento', null, 'soft-skill'),
('Confiança', null, 'soft-skill'),
('Criatividade', null, 'soft-skill'),
('Diversidade e Inclusão', null, 'soft-skill'),
('Ética de Trabalho', null, 'soft-skill'),
-- 80
('Empatia', null, 'soft-skill'),
('Entusiasmo', null, 'soft-skill'),
('Equilíbrio Trabalho-Vida', null, 'soft-skill'),
('Foco em Resultados', null, 'soft-skill'),
('Foco no Cliente', null, 'soft-skill'),
('Gestão do Tempo', null, 'soft-skill'),
('Habilidade Analítica', null, 'soft-skill'),
('Habilidade de Negociação', null, 'soft-skill'),
('Humildade', null, 'soft-skill'),
('Inovação', null, 'soft-skill'),
('Integridade', null, 'soft-skill'),
('Justiça', null, 'soft-skill'),
('Liderança', null, 'soft-skill'),
('Liderança Servidora', null, 'soft-skill'),
('Mente Aberta', null, 'soft-skill'),
('Motivação Intrínseca', null, 'soft-skill'),
('Otimismo', null, 'soft-skill'),
('Organização', null, 'soft-skill'),
('Paciência', null, 'soft-skill'),
--100
('Pensamento Crítico', null, 'soft-skill'),
('Resiliência', null, 'soft-skill'),
('Resolução de Conflitos', null, 'soft-skill'),
('Resolução Proativa de Problemas', null, 'soft-skill'),
('Responsabilidade', null, 'soft-skill'),
('Respeito', null, 'soft-skill'),
('Sustentabilidade', null, 'soft-skill');
