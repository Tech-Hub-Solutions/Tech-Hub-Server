...
-- I.A. -47
('TensorFlow', 'I.A.', 'hard-skill'),
('PyTorch', 'I.A.', 'hard-skill'),
('scikit-learn', 'I.A.', 'hard-skill'),
('Keras', 'I.A.', 'hard-skill'),
('Redes Neurais', 'I.A.', 'hard-skill'),
('Linguagem Natural', 'I.A.', 'hard-skill'),
('Visão Computacional', 'I.A.', 'hard-skill'),
('Aprendizado de Máquina', 'I.A.', 'hard-skill'),
('Deep Learning', 'I.A.', 'hard-skill'),
-- Segurança -57
('Firewalls', 'Segurança', 'hard-skill'),
('Antivírus', 'Segurança', 'hard-skill'),
('Criptografia', 'Segurança', 'hard-skill'),
('Autenticação de Dois Fatores', 'Segurança', 'hard-skill'),
